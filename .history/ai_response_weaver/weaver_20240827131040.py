...
class CustomParser:
    def __init__(self, config):
        ...
        self.current_code_block = []  # Add this line to store content of current code block
    ...
    def _handle_scanning_state(self, line):
        ...
        if file_path:
            ...
            self.current_code_block = []  # Reset current code block
            print(
            ...
            print(
                f"DEBUG: CustomParser._handle_scanning_state - Started code block without file path")
