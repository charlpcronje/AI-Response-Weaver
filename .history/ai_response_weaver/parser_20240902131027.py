...
class CustomParser:
    ...
    logging.info("About to display code block")
    self.ui.display_code_block('\n'.join(self.current_code_block),
                               self.current_line_number,
                               len(self.current_code_block))
    logging.info("Code block displayed")

    # Prompt for action
    logging.info("About to prompt for action")
    action = self.ui.prompt_for_code_block_action("code")
