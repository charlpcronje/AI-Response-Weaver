...
class AIResponseWeaver:
    ...
    def _create_backup(self, file_path):
        ...
        backup_path = os.path.join(
            backup_dir, f"{file_name}-{timestamp}")
        ...
        self.repo.index.commit(
            f"Update files in branch {branch_name}")
        print(
            f"DEBUG: AIResponseWeaver._commit_changes - Changes committed")

        def _trigger_merge(self, branch_name):
        print(
            f"DEBUG: AIResponseWeaver._trigger_merge - Triggering merge for branch: {branch_name}")
        vscode_executable = os.getenv(
        ...
        print(
            f"DEBUG: get_weaver_settings - Settings loaded from .weaver file")
        ...
        print(
            f"DEBUG: get_weaver_settings - Settings saved to .weaver file")
        ...
        weaver = AIResponseWeaver(
            file_to_monitor, log_folder, config)
        ...
        print(
            f"DEBUG: main - Keyboard interrupt received, stopping observer")
        observer.stop()
        observer.join()
